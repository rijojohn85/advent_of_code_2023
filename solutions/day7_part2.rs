...
fn get_hand(hand: &str) -> Hand {
    ...
    if my_map.len() == 1 {
        ...
        if value == &4 {
            if j_count == 1 || j_count == 4 {
                return Hand::FiveOfAKind;
            }
            return Hand::FourOfAKind;
        } else if value == &3 {
            if j_count == 2 || j_count == 3 {
                return Hand::FiveOfAKind;
            }
        ...
        if value == &2 && (j_count == 1 || j_count == 2) {
            return Hand::ThreeOfAKind;
        }
        return Hand::OnePair;
    } else if my_map.len() == 5 && j_count == 1 {
        return Hand::OnePair;
    }
    Hand::HighCard
}
...
mod test {
    ...
    #[test]
    fn test_j_full_house() {
        let hand = "JAA99";
        let a = get_hand(hand);
        assert_eq!(a, Hand::FullHouse);
    }
    #[test]
    fn test_j_three_of_a_kind() {
        let hand = "JAAT9";
        let a = get_hand(hand);
        assert_eq!(a, Hand::ThreeOfAKind);
        let hand = "JJAT9";
